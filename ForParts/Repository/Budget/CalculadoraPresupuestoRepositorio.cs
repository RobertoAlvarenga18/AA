...
namespace API_REST_PROYECT.Repository
{
    public class CalculadoraPresupuestoRepositorio : ICalculadoraPresupuesto
    {
            ...
            public bool TieneStockDisponible(string nombre, string color, decimal largoNecesario, int cantidadRequerida)
            {
                ...
                List<Profile> perfilesDisponibles = RepoStock.GetAvailableProfiles(nombre, color, largoNecesario);
        ...
        async Task<BudgetedProduct> ICalculadoraPresupuesto.CalcularPresupuestoVentanaS20(ProductBudgetDto dto)
        {
            throw new NotImplementedException();
        }

        async Task<BudgetedProduct> ICalculadoraPresupuesto.CalcularPresupuestoVentanaS25(ProductBudgetDto prodDto)
        {
            throw new NotImplementedException();
        }

        Task<BudgetedProduct> ICalculadoraPresupuesto.CalcularPresupuestoVentanaGalaCR(ProductBudgetDto prodDto)
        {
            throw new NotImplementedException();
        }

        Task<BudgetedProduct> ICalculadoraPresupuesto.CalcularPresupuestoVentanaGala(ProductBudgetDto prodDto)
        {
            throw new NotImplementedException();
        }

        async Task<BudgetedProduct> ICalculadoraPresupuesto.CalcularPresupuestoVentanaSumma(ProductBudgetDto prodDto)
        {
            throw new NotImplementedException();
        }
    }
